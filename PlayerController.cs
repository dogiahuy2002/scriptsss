...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        // The float variables, moveHorizontal and moveVertical, hold the value of the virtual axes, X and Z.
        // It records input from the keyboard.
        float moveHorizontal = Input.GetAxis("Horizontal");
        float moveVertical = Input.GetAxis("Vertical");

        // Vector3 variable, movement, holds 3D positions of the player ball in the form of X, Y, and Z axes in space.
        Vector3 movement = new Vector3(moveHorizontal, 0.0f, moveVertical);

        // Adds force to the player ball to move around.
        // Using 3D position, speed, Time.deltaTime
